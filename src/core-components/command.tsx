...
>(({ className, ...props }, ref) => (
	<div
		className="flex items-center border-b border-neutral-500"
		cmdk-input-wrapper=""
	>
		...
		<CommandPrimitive.Input
			ref={ref}
			className={cn(
				'flex h-10 w-full rounded-t-md bg-transparent py-3 text-sm outline-hidden focus:ring-transparent focus:border-neutral-500 placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50',
				className,
			)}
			{...props}
		/>
